...
Теперь самое интересное. Пока цикл всё ещё исполняется, изменми `30` в строке `use_bpm 30` на`50`. Ого, всё ускорилось, но продолжает звучать *равномерно во времени*! Попытайтесь разогнаться ещё быстрее - до 80, до 120, или, сойдите с ума, и дайте 200!
