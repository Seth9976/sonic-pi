...
Если вы не уверены, какой способ поделиться своей работой с остальными лучший, я рекомендую размещать свой код на [GitHub](https://github.com) и музыку на [SoundCloud](https://soundcloud.com). Таким образом вы сможете охватить большую аудиторию.

## Код -> GitHub

[GitHub](https://github.com) - это сайт для обмена и работы с кодом. Он используется профессиональными разработчиками, а также художниками для обмена и совместной работы с кодом. Самый простой способ поделиться новым куском кода (или даже незавершённым куском) - создать [Gist](https://gist.github.com). [Gist](https://gist.github.com) - это простой способ загружать свой код в удобной форме, чтобы другие могли увидеть, скопировать и поделиться им.

## Аудио -> SoundCloud

Еще один отличный способ поделиться вашей работой - сделать аудио запись и загрузить её на [SoundCloud](https://soundcloud.com). После того как вы загрузили свою запись, другие пользователи могут комментировать и обсуждать её. Я также рекомендую поместить ссылку на ваш код в [Gist](https://gist.github.com) в описание трека.
