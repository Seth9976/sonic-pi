...
Note que valores que são passados através de `set` e `cue` devem ser seguros - i.e. Rings imutáveis, números, símbolos ou cadeias congeladas. O Sonic Pi irá gerar um erro se o valor que tenta armazenar no Time State não for válido.
