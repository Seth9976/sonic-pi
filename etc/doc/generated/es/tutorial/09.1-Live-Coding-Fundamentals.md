...
No añadió una nueva capa porque usamos hilos nombrados, los que sólo permiten un hilo por cada nombre. El sonido cambió porque *redefinimos* la función. LE dimos a `:my_loop`una nueva definición. CUando el hilo `:looper` bucleó, simplemente llamó la nueva definición.
