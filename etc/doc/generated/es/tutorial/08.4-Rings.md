...
Super, obtuvimos `55`y después `59`. Sin embargo, si lo hacemos de nuevo, se nos acaban los números de la lista y obtenemos `nil`. Si quisiésemos buclear y volver a comenzar la lista, usaríamos los anillos.

## Creando Anillos

Podemos crear anillos de dos maneras: con la función `ring`y los elementos del anillo como parámetros:
