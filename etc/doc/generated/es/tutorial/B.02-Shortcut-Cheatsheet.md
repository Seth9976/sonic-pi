...
* `C-SPACE` - Establece marca. La navegación manipulará ahora la región resaltada. Usa `C-g` para escapar.
...
* `S-M-s` - Guarda los contenidos del búfer en un archivo
* `S-M-o` - Carga los contenidos de un archivo en el búfer
