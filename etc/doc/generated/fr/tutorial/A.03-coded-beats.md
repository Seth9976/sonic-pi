...
Maintenant, voici la partie amusante. Pendant que la boucle est en train de tourner, changez le `30` dans la ligne `use_bpm 30` en `50`. Waouh, tout est devenu plus rapide, mais *reste synchronisé* - Essayer encore d'accélérer jusqu'à 80, jusqu'à 120, ou même, soyons fous, 200 !
