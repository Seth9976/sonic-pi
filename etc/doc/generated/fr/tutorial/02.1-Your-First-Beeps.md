...
Waouh, c'est fou ! Je suis sûr que vous pourriez continuer à faire cela toute la journée. Mais attendez, avant que vous ne vous perdiez dans un flot infini de bips, essayez de changer le nombre :
...
Il y a aussi un raccourci pratique pour un repos (une façon musicale de dire de ne rien jouer à la place d'une note) en utilisant `:r`, `:rest` ou `nil`.

Maintenant *défoulez-vous* et faites-vous plaisir en faisant vos propres morceaux.
