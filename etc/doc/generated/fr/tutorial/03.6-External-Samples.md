...
Alors comment faire pour jouer n'importe quel fichier WAV, AIFF, OGG, OGA, FLAC ou MP3 sur votre ordinateur ? Tout ce dont vous avez besoin est de renseigner le chemin de ce fichier à `sample` :
