...
Dans l’épisode 3 de cette série sur Sonic Pi, nous avons regardé comment boucler, étirer et filtrer un des breaks de batterie les plus connus de tous les temps - l'Amen Break. Dans ce tutoriel, nous allons faire un pas de plus et apprendre comment le découper, mélanger les bouts et les recoller ensemble dans un agencement complètement nouveau. Si cela vous paraît un peu fou, ne vous inquiétez pas, tout va s'éclaircir et vous maîtriserez bientôt un nouvel outil puissant pour vos sessions de Live Coding.
