...
La fonction `sample` va d'abord rassembler toutes les sources et les utiliser pour créer une grande liste de candidats. Cette liste est construite en ajoutant d'abord tous les chemins valides puis en ajoutant tous les fichiers valides `.flac`, `.aif`, `.aiff`, `.wav`, `.wave`, et `.mp3` contenus dans les dossiers.
