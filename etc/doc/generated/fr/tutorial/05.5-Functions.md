...
Rappelez-vous d'ajouter un deux-points `:` devant le nom de votre fonction quand vous la définissez. Les noms de fonctions devraient également commencer par une lettre minuscule, donc utilisez `:foo` plutôt que `:Foo`.
