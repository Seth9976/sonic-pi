...
O poder real surge quando você mistura `tick` com anéis (rings) e `live_loop`s. Quando combinados nós temos todas as ferramentas que nós precisamos para tanto construir quanto entender um arpejador simples. Precisamos somente de 4 coisas:

1. Um anel (ring) contendo as notas que queremos arpejar.
2. Uma forma de incrementar e obter a batida.
3. A habilidade de tocar uma nota baseada na batida atual.
4. Uma estrutura de loop para manter o arpejador repetindo.
