...
(without-namespace-in-synthdef
 ...
 (defsynth sonic-pi-bnoise_gated
   [amp 1
    amp_slide 0
    amp_slide_shape 1
    amp_slide_curve 0
 ...
 (defsynth sonic-pi-pnoise_gated
   [amp 1
    amp_slide 0
    amp_slide_shape 1
    amp_slide_curve 0
 ...
 (defsynth sonic-pi-gnoise_gated
   [amp 1
    amp_slide 0
    amp_slide_shape 1
    amp_slide_curve 0
 ...
 (defsynth sonic-pi-cnoise_gated
   [amp 1
    amp_slide 0
    amp_slide_shape 1
    amp_slide_curve 0
   ...
   (core/save-synthdef sonic-pi-noise_gated)
   (core/save-synthdef sonic-pi-pnoise_gated)
   (core/save-synthdef sonic-pi-bnoise_gated)
   (core/save-synthdef sonic-pi-gnoise_gated)
   (core/save-synthdef sonic-pi-cnoise_gated)
   )
