...
(without-namespace-in-synthdef
    (defsynth sonic-pi-dark_ambience_gated
     [note 52
      note_slide 0
      note_slide_shape 1
      note_slide_curve 0
    ...
    (defsynth sonic-pi-hollow_gated
     [note 52
      note_slide 0
      note_slide_shape 1
      note_slide_curve 0
    ...
    (defsynth sonic-pi-growl_gated
     ...
     (let [decay_level (select:kr (= -1 decay_level) [decay_level sustain_level])
      ...
      (core/save-synthdef sonic-pi-dark_ambience_gated)
      (core/save-synthdef sonic-pi-hollow_gated)
      (core/save-synthdef sonic-pi-growl_gated))
